...
export default function PerguntaDetalhe({ route }) {

    const Navigator = useNavigation();
    const [carregando, setCarregando] = useState(false)
    const [erro, setErro] = useState(false)
    const [pergunta, setPergunta] = useState(route.params)
    ...
    async function atualizar() {
        setCarregando(true);
        try {
            const docRef = doc(db, 'Pergunta', pergunta.id);
                ...
                {carregando ? (
                    ...
                    <>
                        ...
                        <ScrollView>
                            ...
                            <TextInput style={styles.input} onChangeText={(text) => setPergunta({ ...pergunta, titulo: text })} value={pergunta.titulo} />
                           ...
                           <View style={styles.box}>
                                ...
                                <Text style={styles.textBox}>pergunta {operacao} com sucesso!!!</Text>
