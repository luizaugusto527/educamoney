...
export default function AulaDetalhe({ route }) {

    const Navigator = useNavigation();
    const [carregando, setCarregando] = useState(false)
    const [erro, setErro] = useState(false)
    const [aula, setAula] = useState(route.params)
    ...
    async function atualizar() {
        setCarregando(true);
        try {
            const docRef = doc(db, 'Aula', aula.id);
                ...
                {carregando ? (
                    ...
                    <>
                        ...
                        <ScrollView>
                            ...
                            <TextInput style={styles.input} multiline={true}  numberOfLines={10}  onChangeText={(text) => setAula({ ...aula, descricao: text })} value={aula.descricao} />
                           ...
                           <View style={styles.box}>
                                ...
                                <Text style={styles.textBox}>Aula {operacao} com sucesso!!!</Text>
